...
#define LV_COLOR_DEPTH 16 //使用rgb565
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (32 * 1024U)   //lvgl可以使用的内存       /*[bytes]*/
 ...
 * - LV_OS_MQX
 * - LV_OS_CUSTOM */
#define LV_USE_OS   LV_OS_NONE//使用rtos的线程管理
...
#define MY_DISP_HOR_RES 320//屏幕宽
#define MY_DISP_VER_RES 240//高

/*Align the stride of all layers and images to this bytes*/
#define LV_DRAW_BUF_STRIDE_ALIGN                1//每行数据1字节对齐

/*Align the start address of draw_buf addresses to this bytes*/
#define LV_DRAW_BUF_ALIGN                       4//缓冲区4字节对齐
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (24 * 1024) //绘图缓冲区内存大小  /*[bytes]*/
