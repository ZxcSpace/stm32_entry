...
/******************************************************************************/
#define AI_TEST_MODEL_NAME          "test"
#define AI_TEST_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_TEST_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TEST_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TEST_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TEST_IN_NUM        (1)

AI_DEPRECATED
#define AI_TEST_IN \
  ai_test_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TEST_IN_SIZE { \
  AI_TEST_IN_1_SIZE, \
}
#define AI_TEST_IN_SIZE_BYTES { \
  AI_TEST_IN_1_SIZE_BYTES, \
}
#define AI_TEST_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TEST_IN_1_CHANNEL     (2000)
#define AI_TEST_IN_1_SIZE        (2000)
#define AI_TEST_IN_1_SIZE_BYTES  (8000)

/******************************************************************************/
#define AI_TEST_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TEST_OUT \
  ai_test_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TEST_OUT_SIZE { \
  AI_TEST_OUT_1_SIZE, \
}
#define AI_TEST_OUT_SIZE_BYTES { \
  AI_TEST_OUT_1_SIZE_BYTES, \
}
#define AI_TEST_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TEST_OUT_1_CHANNEL     (3)
#define AI_TEST_OUT_1_SIZE        (3)
#define AI_TEST_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_TEST_N_NODES (8)
 ...
 * @ref ai_test_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_TEST_*
 * defines into file @ref test.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
