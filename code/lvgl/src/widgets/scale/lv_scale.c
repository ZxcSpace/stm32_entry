...
void zxc_lv_scale_set_line_needle_value(lv_obj_t * obj, lv_obj_t * needle_line, int32_t needle_length,
                                    int32_t value, int32_t x_ofs, int32_t y_ofs)
{
    int32_t angle;
    ...
    lv_obj_align(needle_line, LV_ALIGN_TOP_LEFT, x_ofs, y_ofs);
